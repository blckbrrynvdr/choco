...
function setVideoDuration() {
    ...
    // if (video.paused) {
    //     video.play();
    //     playBtn.classList.add("video__player-img--active");
    //     playerPlayBtn.classList.add('active');
    // } else {
    //     video.pause();
    //     playBtn.classList.remove("video__player-img--active");
    //     playerPlayBtn.classList.remove('active');
    // }
...
video.addEventListener('loadeddata', function () {
    ...
    playbakcLine = document.getElementById('playbackLine');
    ...
    durationControl.addEventListener('click', function (e) {
        e.preventDefault();
        ...
        playbakcLine.style.width = `${newButtonPositionPercent}%`;
...
function updateDuration() {
    ...
    playbakcLine.style.width = `${percent}%`;
}
